      ...
      return {
        ...
        projectsData :
          ...
          {name: 'ZDE site',
            ...
            features: ['Front with ordering services',
          ...
          {name: 'Shoe Shop',
            ...
            features: ['Front styles with Sass',
