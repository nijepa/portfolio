          ...
          <div class="cover-wrapper__inner" v-on:click="seek">
            ...
            <div class="music__btn" @click.prevent="isPlaying ? pause(track) : play(track)">
                ...
                <svg v-on:click.prevent="playing = !playing" v-else class="Capa_1" id="Layer_1" x="0px" y="0px"
                  ...
                  <g>
                    <g>
                      <path d="M266.243,416.5c-8.078,0-14.629,6.557-14.629,14.636c0,8.079,6.551,14.629,14.629,14.629s14.629-6.551,14.629-14.629
                  ...
                  <g>
                    <g>
                      <path d="M225.344,153.6h-57.116c-8.078,0-14.629,6.551-14.629,14.629v175.543c0,8.078,6.551,14.629,14.629,14.629h57.116
                  ...
                  <g>
                    <g>
                      <path d="M340.878,153.6h-57.116c-8.078,0-14.629,6.551-14.629,14.629v175.543c0,8.078,6.551,14.629,14.629,14.629h57.116
...
<script>
  export default {
    ...
    mounted() {
      this.track = new Audio(this.getAudioUrl('1976_Tommy_McCook_Prophets_Death_Trap'));
    ...
    watch: {
      playing (value) {
        if (value) { return this.track.play(); }
        this.track.pause();
      }
    },
