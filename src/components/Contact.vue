      ...
      <div class="main-title">
        <form action="">
          ...
          <div class="input-group">
            ...
            <!-- <p v-if="errorName" class="error">please enter name</p> -->
          </div>
          <div class="input-group">
            <input type="text" name="email" placeholder="e-mail" 
                    v-model="senderMail" @input="clearErrors"
                    @blur="clearErrors" :class="errorMail ? 'error' : ''" required>
            <!-- <p v-if="errorMail">please enter e-mail address</p> -->
          </div>
          <div class="input-group">
            ...
            <!-- <p v-if="errorMessage">please enter something</p> -->
          </div>
          <div id="create" @click="sendMail">
            SEND 
  ...
  export default {
    ...
    methods: {
      sendMail() {
        ...
        window.open('mailto:' + this.senderMail + 
