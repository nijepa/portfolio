    ...
    <div class="top">
      ...
      <header class="hero">
        ...
        <transition name="bounce">
          <a class="pdf__link" href="CV-English2021.pdf" download="CV-English2021.pdf" v-on:load="onApeared" v-show="apeared">
            <button id="textme"> 
...
<script>
  export default {
    ...
    methods: {
      ...
      readFile() {
        window.open('../assets/images/CV-English2021.pdf', '_blank') //to open in new tab
      },
...
/* ABOUT */
  ...
  .price {
    ...
    border-image-source: linear-gradient(to right, #1247f7, var(--orange) );
  ...
  .price2 {
    border-image-source: linear-gradient(to right, #ffb515, var(--yellow));
    color: var(--yel);
  }
